...
<%
	...
	try{
		...
		List<Employee> workAnnivList  = new ArrayList<Employee>();
		...
		workAnnivList = empService.getWorkAnniversaryList(null, month, company);
		System.out.println("workAnnivList->"+workAnnivList.size());
		//getWorkAnniversaryList(null, month, company);
		...
		String logoPath=property.getProperty("anniversary_logo.filepath");
		
		 XSSFWorkbook book= new XSSFWorkbook();
		 XSSFSheet sheet= book.createSheet("AnniversarySheet");
		 System.out.println("Sheet created.");
		 
		 InputStream is = null;
			
		 is = new FileInputStream(logoPath+File.separator+"anniversarysheetLogo.png");
		    ...
		    is.close();
		      ...
		      cell.setCellValue("WORK ANNIVERSARY SHEET");
		      ...
		      String[] index={"Employee Code.","Employee Name","Date Of Joining"};
		      ...
		      System.out.println("anniversarysheet header row Created");
		     ...
		     /*  if(request.getParameter("type")!=null && request.getParameter("type").equalsIgnoreCase("birthday"))
		      {
					...
					System.out.println("anniversarysheet header row respective cell Created");
// 		      }
		    			 
	
File anniversaryfile = new File(property.getProperty("anniversary.filepath")); 

if(!anniversaryfile.isDirectory()){
	anniversaryfile.mkdirs();
	}
//InputStream is = new FileInputStream(file);
FileOutputStream fileOut = new FileOutputStream(anniversaryfile+"\\"+"Anniversary.xlsx"); 
...
String downloadExcelFileName="Anniversary.xlsx";
...
File file = new File(property.getProperty("anniversary.filepath")); 
//InputStream is = new FileInputStream(file);
//FileInputStream fileIn = new FileInputStream(file); 
FileInputStream fileIn = new FileInputStream(file+"\\"+"Anniversary.xlsx"); 
