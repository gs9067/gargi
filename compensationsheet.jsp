...
String empId = request.getParameter("empl");
...
String designation = request.getParameter("designtn");

String deprtmnt = request.getParameter("departmnt");
System.out.println("cmpnyId->"+deprtmnt);

String level = request.getParameter("level");

String location = request.getParameter("locatn");


 /* Employee employee = empService.getEmployeeById(Integer.parseInt(empId));
System.out.println("employee->"+employee); 
	    */
empList= empService.getEmpListForCompemsationReport(empId,designation,deprtmnt,level,location);
...
String logoPath=property.getProperty("supervisorsheet_logo.filepath");
 ...
 XSSFSheet sheet= book.createSheet("compensation sheet");
